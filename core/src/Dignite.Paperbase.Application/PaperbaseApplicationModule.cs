...
public class PaperbaseApplicationModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services
            ...
            .Validate(o => o.EmbeddingDimension == PaperbaseDbProperties.EmbeddingVectorDimension,
                $"PaperbaseRag:EmbeddingDimension must equal PaperbaseDbProperties.EmbeddingVectorDimension " +
