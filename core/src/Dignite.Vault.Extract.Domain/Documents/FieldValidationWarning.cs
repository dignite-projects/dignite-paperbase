...
/// <c>Field</c>, discards warnings for undeclared / stale fields, deduplicates by field, truncates the message
/// at a valid UTF-16 boundary, and caps the count (#527 §3). The aggregate builds / reconciles the persisted
/// <see cref="DocumentFieldValidationWarning"/> rows from this set and couples the blocking review bit.
/// </para>
/// </summary>
