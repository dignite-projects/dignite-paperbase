...
/// <c>PaperbaseHostModule.ConfigureAI</c> adds or removes a <c>AddKeyedChatClient(...)</c> call,
...
public class KeyedChatClientRegistration_Tests
{
    ...
    private static readonly Assembly[] ProductionAssemblies =
    {
        ...
        typeof(IDocumentRepository).Assembly,                  // Dignite.Paperbase.Domain
        typeof(DocumentDto).Assembly,                          // Dignite.Paperbase.Application.Contracts
        typeof(DocumentClassificationWorkflow).Assembly,       // Dignite.Paperbase.Application (where keyed consumers live)
    };
