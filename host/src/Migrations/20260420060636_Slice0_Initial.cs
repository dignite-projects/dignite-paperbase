...
{
    /// <inheritdoc />
    public partial class Slice0_Initial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: true),
                    OriginalFileBlobName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: false),
                    SourceType = table.Column<int>(type: "integer", nullable: false),
                    FileOrigin_UploadedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    FileOrigin_UploadedByUserId = table.Column<Guid>(type: "uuid", nullable: false),
                    FileOrigin_UploadedByUserName = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    FileOrigin_OriginalFileName = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    FileOrigin_ContentType = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    FileOrigin_FileSize = table.Column<long>(type: "bigint", nullable: false),
                    FileOrigin_DeviceInfo = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                    FileOrigin_ScannedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PipelineCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaperbaseDocumentPipelineRuns_DocumentId_PipelineCode_Attem~",
