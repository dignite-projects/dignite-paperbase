...
- `docs/` contains developer-facing documentation organized by feature (e.g. `text-extraction.md`, `embedding.md`, `chat.md`) and internal design documents under `docs/design/`.
